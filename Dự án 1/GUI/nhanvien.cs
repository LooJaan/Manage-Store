    ...
    public partial class nhanvien : Form
    {
        ...
        public void loadnhanVien()
        {
            var kq = nv.getAllnhanvienSer().Select( x => new
            {
                ...
                x.Manv, x.Tennv, x.Cccd, x.Ngaysinh, x.Gioitinh, x.Sdt, x.Quyen, x.Taikhoan, x.Matkhau, x.Diachi, x.Tinhtrang
            });
        ...
        private void dgv_diaChi_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtTen.Text = dgv_diaChi.Rows[i].Cells[1].Value.ToString();
            txtcccd.Text = dgv_diaChi.Rows[i].Cells[2].Value.ToString();
            txtsđt.Text = dgv_diaChi.Rows[i].Cells[5].Value.ToString();
            txt_quyen.Text = dgv_diaChi.Rows[i].Cells[6].Value.ToString();
            txt_taiKhoan.Text = dgv_diaChi.Rows[i].Cells[7].Value.ToString();
            txt_matKhau.Text = dgv_diaChi.Rows[i].Cells[8].Value.ToString();
            txt_diaChi.Text = dgv_diaChi.Rows[i].Cells[9].Value.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            var q = from x in nv.getAllnhanvienSer()
                    where x.Tennv.ToLower().Contains(txt_tìmKiem.Text.ToLower())
                    select new
                    {
                        x.Manv,
                        x.Tennv,
